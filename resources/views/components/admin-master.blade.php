...
<div id="wrapper">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePosts" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('post.create')}}">Craete a Post</a>
    ...
    @if(auth()->user()->userHasRole('admin'))
        ...
        <li class="nav-item">
            ...
            <div id="collapseUsers" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('user.create')}}">Craete a User</a>
                </div>
            </div>
        </li>

            <!-- Nav Item - categories Custom -->
            <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div id="collapseAuthorization" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
...
{{--                    <div class="bg-white py-2 collapse-inner rounded">--}}
{{--                        <h6 class="collapse-header">Custom Comments:</h6>--}}
{{--                        <a class="collapse-item" href="{{route('comments.index')}}">View All Comments</a>--}}
{{--                        <a class="collapse-item" href="{{route('comments.create')}}">Craete a Comment</a--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </li>--}}
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="{{route('user.show.profile',auth()->user())}}">
